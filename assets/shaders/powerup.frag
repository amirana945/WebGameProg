...
void main() {
    ...
    if (centerDistance - ooze_factor < 0.5) {
        ...
        vec3 out_color = mix(c_white, c_green, smoothstep(0.0, 0.9, noise));
        out_color = mix(out_color, c_white, abs(sin(20.0 * u_time)));
